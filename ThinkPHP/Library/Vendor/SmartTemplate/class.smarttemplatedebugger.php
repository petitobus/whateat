	...
	*/
	class SmartTemplateDebugger
	{
		...
		*/
		...
		/**
		* Splits Template-CSS Variable Names into an Array-Name/Key-Name Components
		*
		* @param string $tag Variale Name used in Template
		* @return array  Array Name, Key Name
		* @access private
		* @desc Splits Template-CSS Variable Names into an Array-Name/Key-Name Components
		*/
